...
import { AnimeSparkles } from "./anime-sparkles";
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 text-center">
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-xl mx-auto mb-10 animate-slide-up [animation-delay:0.2s] opacity-0">
          Describe the moments closest to your heart — we&apos;ll transform them
          into beautiful anime-style art you can keep forever.
        </p>
